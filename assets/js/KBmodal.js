...
**/
	...
	function KBmodal(url, type, objname, gallery, notcloseable) {
	    ...
	    generateGalleryModal = function(){
	    	...
	    	modalBody += '<div class="KBgalleryNav KBprev"><i class="fas fa-cookie-bite" aria-hidden="true"></i></div>';

	    	modalBody += '<img src="'+self.contentUrl+'">';

	    	modalBody += '<div class="KBgalleryNav KBnext"><i class="fas fa-cookie-bite" aria-hidden="true"></i></div>';
